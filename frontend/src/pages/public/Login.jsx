        ...
        <div className="mb-6 p-4 rounded-2xl bg-indigo-50/80 border border-indigo-100 space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="py-2 px-2.5 bg-white rounded-xl border border-indigo-200 shadow-xs text-xs font-semibold text-slate-800 hover:bg-brand-600 hover:text-white hover:border-brand-600 focus-visible:ring-2 focus-visible:ring-brand-500 transition-all"
            >
              🎓 Student
            </button>
            <button
